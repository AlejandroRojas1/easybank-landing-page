...
const Footer = () => {
    return (
        <>
            <footer className={`${styles.footer} w-full px-3 sm:px5 md:px-16 lg:px-28 xl:px-40 py-10 bg-darkBlue relative`}>
                <div className={`${styles.navFooterContainer}`}>
                    <div className={`${styles.socialContainer} h-28 w-40 `}>
                        ...
                        <div className={`${styles.social} flex justify-between`}>
                    ...
                    <div className={`${styles.nav} text-white`}>
                        <ul className="text-sm">
                            <li><a href="#" className="hover:text-limeGreen">About Us</a></li>
                            <li><a href="#" className="hover:text-limeGreen">Contact</a></li>
                            <li><a href="#" className="hover:text-limeGreen">Blog</a></li>
                        </ul>
                        <ul className="text-sm">
                            <li><a href="#" className="hover:text-limeGreen">Careers</a></li>
                            <li><a href="#" className="hover:text-limeGreen">Support</a></li>
                            <li><a href="#" className="hover:text-limeGreen">Privacy Policy</a></li>
                        </ul>
                    </div>
                </div>
                <div className={`${styles.button} flex flex-col`}>
                    <Button moreStyles='' />
                    <p className='text-grayishBlue text-sm'>© Easybank. All Rights Reserved</p>
                </div>
            </footer>
        </>
    )
